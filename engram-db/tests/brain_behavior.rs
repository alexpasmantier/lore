...
use engram_db::edge::{Edge, EdgeId, EdgeKind};
use engram_db::fragment::{now_unix, Fragment, FragmentId};
use engram_db::relevance::{compute_relevance, decay_rate_for_importance};
...
fn link(db: &EngramDb, source: FragmentId, target: FragmentId, kind: EdgeKind, weight: f32) {
