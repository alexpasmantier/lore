...
You have access to a persistent long-term memory system called **Engram**. This gives you memory that persists across conversations, organized as a hierarchical knowledge graph.
